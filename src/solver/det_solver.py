    ...
    def fit(self, ):
        ...
        for epoch in range(self.last_epoch + 1, args.epoches):
            ...
            if self.output_dir:
                ...
                # checkpoint.pth is overwritten every epoch; numbered checkpoints are sparse.
            ...
            is_best = current_map is not None and current_map > best_stat.get('coco_eval_bbox', -1.0)
